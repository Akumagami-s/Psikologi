...
$("#send").click(function (e) {
        ...
        $('#chat').append('<div class="d-flex justify-content-start mb-4"><div class="img_cont_msg"></div><div class="msg_cotainer">'+$('#msg').val()+'<span class="msg_time">8:40 AM, Today</span></div></div>');
                $('#msg').val('');
      ...
      $.ajax({
            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    console.log('ada');
                    $('#chat').append('<div class="d-flex justify-content-end mb-4"><div class="msg_cotainer_send">'+data[i].message+'<span class="msg_time_send">8:55 AM, Today</span></div><div class="img_cont_msg"></div></div>');
                    }
